import{a as p,b as K,P as z}from"./assets/vendor-a6d4c47e.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=s(r);fetch(r.href,o)}})();const C=Object.freeze({BASE_URL:"https://your-energy.b.goit.study/api",EXERCISES:"/exercises",RATING:"/rating",FILTERS:"/filters",QUOTE:"/quote",SUBSCRIPTION:"/subscription"}),Y=document.querySelector(".daily-quote"),{BASE_URL:J,QUOTE:Z}=C;p.defaults.baseURL=J;const F=new Date().toISOString().split("T")[0],ee=async()=>{const e=await p.get(Z);return{quote:e.data.quote,author:e.data.author,date:F}},I=({author:e,quote:t})=>{Y.innerHTML=`<p class="daily-quote-text">${t}</p>
    <h4 class="daily-quote-author">${e}</h4>`},te=async()=>{const e=localStorage.getItem("quote");if(e){const s=JSON.parse(e);if(s.date===F){I(s);return}}const t=await ee();localStorage.setItem("quote",JSON.stringify(t)),I(t)};te();const{BASE_URL:se,FILTERS:re}=C;p.defaults.baseURL=se;const A=async(e="Muscles",t=1,s=12)=>{const i=new URLSearchParams({filter:e,limit:s,page:t});return(await p.get(`${re}?${i}`)).data},c={body:document.querySelector("body"),groupListWrapper:document.querySelector(".group-list-wrapper"),groupList:document.getElementById("js-group-list"),groupListPagination:document.getElementById("js-group-list-pagination"),exercisesNavList:document.querySelectorAll(".exercises__nav-item"),exercisesWrapper:document.querySelector(".exercises-list-wrapper")},P="selected-category",q="selected-group",b="is-exercises-list-visible",M="group-page",T="exercises-page",R="exercises-keyword",oe="Muscles";class ie{setExercisesListVisible(){sessionStorage.setItem(b,"true")}setExercisesListHidden(){sessionStorage.setItem(b,"false")}isExercisesListVisible(){return sessionStorage.getItem(b)==="true"}setFilterCategory(t){sessionStorage.setItem(P,t)}getFilterCategory(){return sessionStorage.getItem(P)??oe}setGroup(t){sessionStorage.setItem(q,t)}getGroup(){return sessionStorage.getItem(q)??""}setGroupPage(t){sessionStorage.setItem(M,t.toString())}getGroupPage(){const t=sessionStorage.getItem(M);return t?Number(t):1}getExercisesPage(){const t=sessionStorage.getItem(T);return t?Number(t):1}setExercisesPage(t){sessionStorage.setItem(T,t.toString())}setExercisesKeyword(t){sessionStorage.setItem(R,t)}getExercisesKeyword(){return sessionStorage.getItem(R)??""}}const n=new ie;function ae(e){return e.map(({filter:t,name:s,imgURL:i})=>{const r=`data-filter="${t}"`,o=`data-group="${s}"`;return`
      ...
      `}).join("")}function ne(){const e=c.groupList;e.style.opacity="0",K({targets:e,opacity:[0,1],duration:300,easing:"easeOutQuad",complete:()=>{c.groupListPagination.style.display="flex"}})}function k(e,t){e.innerHTML="",ne(),e.insertAdjacentHTML("beforeend",ae(t)),le(),e.querySelectorAll(".group-list-card").forEach(i=>{i.addEventListener("click",()=>{const r=i.getAttribute("data-group");ce(r)})})}function ce(e){const t=document.querySelector(".exercises_name");t.textContent=`/ ${e}`,t.style.display="block",t.style.textTransform="capitalize"}function le(){const e=document.querySelector(".exercises_name");e.style.display="none"}function de({currentPage:e,perPage:t,totalItems:s,totalPages:i,onChange:r}){const o="js-group-list-pagination",a=c.groupListPagination;i>1&&!n.isExercisesListVisible()?a.classList.remove("is-hidden"):a.classList.add("is-hidden");const l={page:Number(e),itemsPerPage:t,totalItems:s,centerAlign:!0,template:{page:'<button href="#">{{page}}</button>',currentPage:'<button href="#" class="is-active">{{page}}</button>',moveButton:'<button href="#" class="is-hidden"></button>',disabledMoveButton:'<button href="#" class="is-hidden"></button>',moreButton:'<button href="#" class="is-hidden"></button>'}};new z(o,l).on("beforeMove",u=>{const m=u.page;r(m)})}async function ue(e){const t=n.getFilterCategory(),s=await A(t,e),{results:i}=s,r=c.groupList;k(r,i)}async function G({page:e,filter:t}){const s=await A(t,e),{results:i,page:r,perPage:o,totalPages:a}=s,l=a*o;de({currentPage:r,perPage:o,totalItems:l,totalPages:a,onChange:u=>{n.setGroupPage(u),ue(u)}});const d=c.groupList;k(d,i)}function B(){n.setExercisesListVisible(),c.groupListWrapper.classList.add("is-hidden"),c.exercisesWrapper.classList.remove("is-hidden")}function N(){n.setExercisesListHidden(),c.groupListWrapper.classList.remove("is-hidden"),c.exercisesWrapper.classList.add("is-hidden")}const ge=document.querySelector(".exercises_nav"),pe=async e=>{try{let t=e.target,s=document.querySelector(".exercises__nav-item-current");((o,a)=>{o.classList.remove("exercises__nav-item-current"),a.classList.add("exercises__nav-item-current")})(s,t);const r=e.target.textContent.trim();c.groupList.innerHTML="",N(),n.setFilterCategory(r),n.setGroupPage(1),n.setExercisesPage(1),n.setExercisesKeyword(""),c.groupListPagination.style.display="none",G({page:1,filter:r})}catch(t){console.error(t)}};ge.addEventListener("click",pe);const{BASE_URL:me,EXERCISES:O}=C;p.defaults.baseURL=me;const H=async(e,t,s=1,i=10)=>{const r=new URLSearchParams({[e]:t,limit:i,page:s}),o=await p.get(`${O}?${r}`);console.log(`Fetching exercises with params: ${r.toString()}`),console.log("API response:",o.data);const a=document.querySelector(".exercises_search-input").value.toLowerCase(),l=o.data.results.filter(d=>d.name.toLowerCase().includes(a));return{...o.data,results:l}},fe=async e=>(await p.get(`${O}/${e}`)).data,g="/energy-project-team/assets/icons-001fdf71.svg";function $(e){return e.charAt(0).toUpperCase()+e.slice(1)}function xe(e){return e.map(({_id:t,bodyPart:s,target:i,rating:r,burnedCalories:o,time:a,name:l})=>`<li id="${t}" class="exercise-card">
          ...
          <div class="exercise-card-content-holder">
            <div class="exercise-card-title-holder">
              ...
              <div class="exercise-card-title-name">${$(l)}</div>
            </div>
            <div class="exercise-card-info-holder">
              ...
              <div class="exercise-card-info">
                ...
                <span class="exercise-card-info-text">${$(s)}</span>
              </div>
              <div class="exercise-card-info">
                <span class="exercise-card-info-title">Target:</span>
                <span class="exercise-card-info-text">${$(i)}</span>
              </div>
            </div>
          </div>
      ...
      </li>`);return}e.insertAdjacentHTML("beforeend",xe(t))}const ye=document.querySelector(".exercises_search-img"),y=document.querySelector(".exercises_criss-cross-img"),h=document.querySelector(".exercises_search-input"),D=async()=>{const e=await H(document.querySelector(".exercises_name").textContent,document.querySelector(".exercises_search-input").value);console.log("Full response:",e),console.log("NAME: "+document.querySelector(".exercises_name").textContent),console.log("SEARCH: "+document.querySelector(".exercises_search-input").value),e&&e.results?(console.log("Exercises data:",e.results),U(c.exercisesWrapper,e.results)):console.error("Invalid response structure:",e)};ye.addEventListener("click",D);y.addEventListener("click",()=>{h.value="",y.style.display="none"});h.addEventListener("input",()=>{h.value.length>0?y.style.display="block":y.style.display="none"});h.addEventListener("keypress",e=>{e.key==="Enter"&&D()});const he={MUSCLES:"muscles",BODY_PARTS:"bodyparts",EQUIPMENT:"equipment"};async function j(){let e=n.getFilterCategory(),t=n.getGroup();e=e.toLowerCase().split(" ").join(""),e===he.BODY_PARTS&&(e=e.slice(0,-1)),t=t==null?void 0:t.toLowerCase();const s=n.getExercisesPage(),i=await H(e,t,s);U(c.exercisesWrapper,i.results)}const ve=n.getGroupPage(),W=n.getFilterCategory();c.groupListPagination.style.display="none";G({page:ve,filter:W});n.isExercisesListVisible()?(j(),B()):N();c.exercisesNavList.forEach(e=>{e.textContent.trim()===W&&e.classList.add("exercises__nav-item-current")});document.addEventListener("DOMContentLoaded",()=>{const e=new URL(window.location.href),t=document.querySelector("#home"),s=document.querySelector("#favorites");(e.href===t.href||e.pathname==="/"||e.pathname==="/energy-project-team.git/")&&(s.classList.remove("current-page"),t.classList.add("current-page")),e.href===s.href&&(t.classList.remove("current-page"),s.classList.add("current-page"))});c.groupList.addEventListener("click",e=>{let t=e.target.dataset.filter,s=e.target.dataset.group;s=s==null?void 0:s.toLowerCase(),t&&s&&(n.setGroup(s),n.setFilterCategory(t),j(),B())});let x=!1,Q;const L=document.querySelector(".modal-exercises"),v=document.querySelector(".overlay"),Le=document.querySelector(".exercises-list-wrapper");Le.addEventListener("click",_e);async function _e(e){if(e.target.closest(".exercise-card-header-btn"))try{const t=e.target.closest(".exercise-card-header-btn").getAttribute("data-id"),s=await fe(e);console.log(s),console.log("Exercise Data:",s),Q=t;const i=$e(s);console.log("Generated Markup:",i),Se(i),Ee(),document.querySelector(".modal-exercises__btn-favorites").addEventListener("click",we),document.querySelector(".modal-exercises__btn-close").addEventListener("click",w)}catch(t){console.log(t)}}function Ee(){const e=window.innerWidth-document.body.offsetWidth+"px";L.classList.remove("hidden"),v.classList.remove("hidden"),document.body.style.paddingRight=e,document.body.style.overflow="hidden"}function Se(e){L.innerHTML=e,Ce()}function be(e){const t="#EEA10C",s="#F4F4F4";let r="";for(let l=0;l<5;l++){const d=`starGradient${l}`,u=l+1<=e?100:l<e?e%1*100:0,m=[{offset:"0%",color:t,opacity:"1"},{offset:`${u}%`,color:t,opacity:"1"},{offset:`${u+1}%`,color:s,opacity:"0.20"}],_=`
      ...
      `,E=`url(#${d})`;r+=`<svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 14 13" fill="none">${_}<path d="M6.04894 0.927052C6.3483 0.0057416 7.6517 0.00574088 7.95106 0.927052L8.79611 3.52786C8.92999 3.93989 9.31394 4.21885 9.74717 4.21885H12.4818C13.4505 4.21885 13.8533 5.45846 13.0696 6.02786L10.8572 7.63525C10.5067 7.8899 10.3601 8.34127 10.494 8.75329L11.339 11.3541C11.6384 12.2754 10.5839 13.0415 9.80017 12.4721L7.58779 10.8647C7.2373 10.6101 6.7627 10.6101 6.41222 10.8647L4.19983 12.4721C3.41612 13.0415 2.36164 12.2754 2.66099 11.3541L3.50604 8.75329C3.63992 8.34127 3.49326 7.8899 3.14277 7.63525L0.930391 6.02787C0.146677 5.45846 0.549452 4.21885 1.51818 4.21885H4.25283C4.68606 4.21885 5.07001 3.93989 5.20389 3.52786L6.04894 0.927052Z" fill="${E}" fill-opacity="1"/></svg>`}return`${Number.isInteger(e)?`${e}.0`:e.toFixed(1)} ${r}`}function $e({_id:e,bodyPart:t,equipment:s,gifUrl:i,name:r,target:o,description:a,rating:l,burnedCalories:d,time:u,popularity:m}){const _=E(i);function E(S){return S===null||!S?'src="https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif"':`src="${S}"`}const f=be(l);return`
        ...
        <div class="modal-exercises__block">
          <ul class="modal-exercises__list">
            ...
            <li class="modal-exercises__item">
              ...
              <p class="modal-exercises__text">${d}/${u}</p>
            </li>
          </ul>
...
`}function w(){L.classList.add("hidden"),v.classList.add("hidden"),document.body.style.paddingRight="0px",document.body.style.overflow="auto"}v.addEventListener("click",function(e){e.target===v&&w()});document.addEventListener("keydown",function(e){e.key==="Escape"&&!L.classList.contains("hidden")&&w()});function Ce(){const e=JSON.parse(localStorage.getItem("exerciseData")),t=document.querySelector(".modal-exercises__btn-favorites");e!=null&&e.some(s=>s._id===Q)?(x=!0,t.innerHTML=X()):(x=!1,t.innerHTML=V())}function we(){x=!x;const e=document.querySelector(".modal-exercises__btn-favorites"),t=document.querySelector(".favorites__list");x?(e.innerHTML=X(),t==null?console.log(""):setTimeout(()=>{createMarkupFavorite()},100)):(e.innerHTML=V(),t==null?console.log(""):setTimeout(()=>{createMarkupFavorite()},100))}function V(){return`
  Add to favorites
    <svg class="btn-favorites__icon">
    <use href="${g}#heart"></use>
