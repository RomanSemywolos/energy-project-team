import{a as g,b as ne,P as W,i as B}from"./vendor-c952f842.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))o(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const n of i.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function r(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(s){if(s.ep)return;s.ep=!0;const i=r(s);fetch(s.href,i)}})();const L=Object.freeze({BASE_URL:"https://your-energy.b.goit.study/api",EXERCISES:"/exercises",RATING:"/rating",FILTERS:"/filters",QUOTE:"/quote",SUBSCRIPTION:"/subscription"}),ce=document.querySelector(".daily-quote"),{BASE_URL:le,QUOTE:de}=L;g.defaults.baseURL=le;const K=new Date().toISOString().split("T")[0],ue=async()=>{const e=await g.get(de);return{quote:e.data.quote,author:e.data.author,date:K}},k=({author:e,quote:t})=>{ce.innerHTML=`<p class="daily-quote-text">${t}</p>
    <h4 class="daily-quote-author">${e}</h4>`},ge=async()=>{const e=localStorage.getItem("quote");if(e){const r=JSON.parse(e);if(r.date===K){k(r);return}}const t=await ue();localStorage.setItem("quote",JSON.stringify(t)),k(t)};ge();const{BASE_URL:pe,FILTERS:me}=L;g.defaults.baseURL=pe;const R=async(e,t=1,r=12)=>{const o=new URLSearchParams({filter:e,limit:r,page:t});return(await g.get(`${me}?${o}`)).data};document.querySelectorAll(".exercises__nav-item").forEach(e=>{e.addEventListener("click",async()=>{const t=e.getAttribute("data-category");try{const r=await R(t)}catch(r){console.error("Error fetching categories:",r)}})});const a={body:document.querySelector("body"),groupListWrapper:document.querySelector(".group-list-wrapper"),groupList:document.getElementById("js-group-list"),groupListPagination:document.getElementById("js-group-list-pagination"),exercisesNavList:document.querySelectorAll(".exercises__nav-item"),exercisesWrapper:document.querySelector(".exercises-list-wrapper"),exercisesListPagination:document.getElementById("js-exercises-list-pagination"),search:document.querySelector(".exercises_search"),searchField:document.querySelector(".exercises_search"),searchInput:document.querySelector(".exercises_search-input"),clearSearchButton:document.querySelector(".exercises_criss-cross-img"),exrciseSlash:document.querySelector(".slash")},O="selected-category",N="selected-group",P="is-exercises-list-visible",D="group-page",G="exercises-page",U="exercises-keyword",fe="Muscles";class ye{setExercisesListVisible(){sessionStorage.setItem(P,"true")}setExercisesListHidden(){sessionStorage.setItem(P,"false")}isExercisesListVisible(){return sessionStorage.getItem(P)==="true"}setFilterCategory(t){sessionStorage.setItem(O,t)}getFilterCategory(){return sessionStorage.getItem(O)??fe}setGroup(t){sessionStorage.setItem(N,t)}getGroup(){return sessionStorage.getItem(N)??""}setGroupPage(t){sessionStorage.setItem(D,t.toString())}getGroupPage(){const t=sessionStorage.getItem(D);return t?Number(t):1}getExercisesPage(){const t=sessionStorage.getItem(G);return t?Number(t):1}setExercisesPage(t){sessionStorage.setItem(G,t.toString())}setExercisesKeyword(t){sessionStorage.setItem(U,t)}getExercisesKeyword(){return sessionStorage.getItem(U)??""}}const c=new ye;function he(e){return e.map(({filter:t,name:r,imgURL:o})=>{const s=`data-filter="${t}"`,i=`data-group="${r}"`;return`
      ...
      `,w=`url(#${u})`;s+=`<svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 14 13" fill="none">${E}<path d="M6.04894 0.927052C6.3483 0.0057416 7.6517 0.00574088 7.95106 0.927052L8.79611 3.52786C8.92999 3.93989 9.31394 4.21885 9.74717 4.21885H12.4818C13.4505 4.21885 13.8533 5.45846 13.0696 6.02786L10.8572 7.63525C10.5067 7.8899 10.3601 8.34127 10.494 8.75329L11.339 11.3541C11.6384 12.2754 10.5839 13.0415 9.80017 12.4721L7.58779 10.8647C7.2373 10.6101 6.7627 10.6101 6.41222 10.8647L4.19983 12.4721C3.41612 13.0415 2.36164 12.2754 2.66099 11.3541L3.50604 8.75329C3.63992 8.34127 3.49326 7.8899 3.14277 7.63525L0.930391 6.02787C0.146677 5.45846 0.549452 4.21885 1.51818 4.21885H4.25283C4.68606 4.21885 5.07001 3.93989 5.20389 3.52786L6.04894 0.927052Z" fill="${w}" fill-opacity="1"/></svg>`}return`${Number.isInteger(e)?`${e}.0`:e.toFixed(1)} ${s}`}function Re({_id:e,bodyPart:t,equipment:r,gifUrl:o,name:s,target:i,description:n,rating:l,burnedCalories:u,time:d,popularity:b}){const E=w(o);function w($){return $===null||!$?'src="https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif"':`src="${$}"`}const f=qe(l);return`
...
`}function T(){S.classList.add("hidden"),y.classList.add("hidden"),document.body.style.paddingRight="0px",document.body.style.overflow="auto"}y&&y.addEventListener("click",function(e){e.target===y&&T()});document.addEventListener("keydown",function(e){e.key==="Escape"&&!S.classList.contains("hidden")&&T()});function z(){const e=document.querySelector(".modal-exercises-btn-favorites");if(!e){console.error("Element not found.");return}if(!e.getAttribute("data-id")){console.error("Element does not have a data-id attribute.");return}const r=window.currentExerciseData;if(!r){console.error("Exercise data is not available.");return}let o=JSON.parse(localStorage.getItem("favorites"))||[];if(o.some(i=>i._id===r._id)){const i=o.findIndex(n=>n._id===r._id);i!==-1&&(o.splice(i,1),console.log(`Removed exercise with ID ${r._id} from favorites.`),localStorage.setItem("favorites",JSON.stringify(o)),e.innerHTML=Z())}else o.push(r),console.log(`Added exercise with ID ${r._id} to favorites.`),localStorage.setItem("favorites",JSON.stringify(o)),e.innerHTML=ee()}function Z(){return`
  ...
  </svg>`}function I(e){return e.charAt(0).toUpperCase()+e.slice(1)}function te(e){return e.map(({_id:t,bodyPart:r,target:o,rating:s,burnedCalories:i,time:n,name:l})=>`<li id="${t}" class="exercise-card">
          ...
          <div class="exercise-card-content-holder">
            ...
            <div class="exercise-card-info-holder">
              <div class="exercise-card-info">
                ...
                <span class="exercise-card-info-text">${i} / ${n} min</span>
              </div>
              <div class="exercise-card-info">
